          ...
          <div className="grad-bg rounded-xl p-6 border border-primary/30 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-3">
                <Badge className="bg-[hsla(273,96%,64%,1)] text-foreground/70 border-purple/30 text-xs">
                <Flame size={14} />
                  14 DAY STREAK
                </Badge>
                <Badge className="bg-[hsla(145,100%,39%,1)] text-foreground/70 border-green/30 text-xs">
                  ACTIVE: 45% DISCOUNT
                </Badge>
              </div>
